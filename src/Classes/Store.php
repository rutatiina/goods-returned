...
use Rutatiina\GoodsReturned\Traits\TxnItemsJournalLedgers as TxnTraitsTxnItemsJournalLedgers;
...
class Store
{
    ...
    public function run()
    {
        ...
        try
        {
            ...
            {
                unset($item['taxes']);
                $item['goods_returned_id'] = $this->txn['id'];
            ...
            {
                $ledger['goods_returned_id'] = $this->txn['id'];
