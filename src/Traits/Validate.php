...
namespace Rutatiina\GoodsReturned\Traits;
...
trait Validate
{
    ...
    private function validate()
    {
        ...
        $this->settings = GoodsReturnedSetting::with(['financial_account_to_debit', 'financial_account_to_credit'])->first();
        ...
        //print_r($data); exit;
        $last_txn = GoodsReturned::latest()->first();
